// ─── Project Rosé ───  analytics  ───

if (location.hostname === "projectrose.cafe") {
  !(function (e, t) {
    var r, o, s, i;
    t.__SV ||
      ((window.posthog = t),
      ...
      (t.init = function (n, a, p) {
        ...
        ((s = e.createElement("script")).type = "text/javascript"),
          ...
          (s.async = !0),
          (s.src =
            a.api_host.replace(".i.posthog.com", "-assets.i.posthog.com") +
            "/static/array.js"),
        ...
        for (
          void 0 !== p ? (c = t[p] = []) : (p = "posthog"),
            ...
            c.toString = function (e) {
              var t = "posthog";
              return "posthog" !== p && (t += "." + p), e || (t += " (stub)"), t;
            },
    ...
    posthog.init("", {
      api_host: "https://projectrose.cafe/ingest",
