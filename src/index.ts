...
const oauthAssociations: { [key: string]: OAuthAssociation } = {};
...
app.get("/tvii/generateTWCode", async (req: Request, res: Response) => {
    try {
...
app.get("/tvii/checkForTWRedirect", (req: Request, res: Response) => {
    try {
...
app.get("/tvii/getAccessTokenTW", async (req: Request, res: Response) => {
    try {
        const code = req.query.code as string | undefined;
...
app.get("/tvii/clientCheckTWCodeVerified", (req: Request, res: Response) => {
    try {
        const code = req.query.code as string | undefined;
